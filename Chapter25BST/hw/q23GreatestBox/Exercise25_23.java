package Chapter25BST.hw.q23GreatestBox;
...
public class Exercise25_23 {
  public static void main(String[] args) {
    ...
    ArrayList<ArrayList<Integer>> permutations = generatePermuation(items);
  ...
  public static ArrayList<ArrayList<Integer>> generatePermuation(int[] items) {
