...
public class Test7 extends Application {
    ...
    class HangmanPane extends Pane {
        ...
        Timeline animation = new Timeline(new KeyFrame(Duration.millis(200), e -> paint()));
        ...
        String[] words = { "write", "program", "that", "receive", "positive", "excellent", "linger", "violin", "strange", "holiday", "twilight", "school", "teacher", "tutor", "mother"};
        String hiddenWord;
