package Chapter22.q13;

import Chapter22.q11.MyPoint;
...
import static Chapter22.q11.Test11.getConvexHull;
...
public class Test13 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("ConvexHull");
    ...
    class View extends Pane {
        ...
        protected void drawNewPolygon() {
            ...
            if (listOfCircle.size() >= 3) {
                ...
                ArrayList<MyPoint> listOfPoints = getConvexHull(points);
