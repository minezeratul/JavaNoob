package chapter23.HW.q9;

import java.util.Comparator;

public class ComparatorHeap {
    public static void main(String[] args) {
       HeapWithComparator<Integer> hwc = new HeapWithComparator(new Comparator<Integer>() {
           @Override
           public int compare(Integer o1, Integer o2) {//increasing
               if (o1 > o2)
                   return -1;
               else if (o1 < o2)
                   return 1;
